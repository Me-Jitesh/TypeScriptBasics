...
// const  has global scope but do not  allow Re-Initialization,Declaration, Rendering,Shadowing & Hoisting
...
function hoisting() {
  ...
  PI = 3.14; // not a valid variable but still not throw error
